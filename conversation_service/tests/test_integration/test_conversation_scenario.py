...
intent_module = pytest.importorskip("conversation_service.agents.intent_classifier")
IntentClassificationCache = getattr(intent_module, "IntentClassificationCache", None)
...
query_module = pytest.importorskip("conversation_service.agents.query_generator")
QueryOptimizer = getattr(query_module, "QueryOptimizer", None)
