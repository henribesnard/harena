...
def create_app():
    ...
    async def startup():
        ...
        # 4. Search Service - CORRECTION FINALE
        logger.info("🔍 Chargement search_service...")
        try:
            # Méthode 1: Import direct depuis routes.py
            try:
                ...
                logger.info(f"✅ search_service (direct): {routes_count} routes sur /api/v1/search")
