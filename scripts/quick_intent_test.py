...
class HarenaIntentAgent:
    ...
    def _create_system_prompt(self) -> str:
        ...
        lines += [
            ...
            "- Chaque entité doit inclure un champ confidence (0.0-1.0)",
            "",
            "RÈGLES IMPORTANTES:",
            ...
            "6. Chaque entité doit inclure un champ confidence (0.0-1.0)",
            "7. Si l'utilisateur demande une action (paiement, virement, transfert, export),",
