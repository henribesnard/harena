...
class HarenaRealDataTestClient:
    ...
    def run_all_tests(self, username: str, password: str) -> bool:
        """Lance l'ensemble des tests avec données réelles."""
...
def main():
    ...
    try:
        success = client.run_all_tests(args.username, args.password)
